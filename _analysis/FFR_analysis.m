...
for s=setdiff(79:length(subdir),[2])
    ...
    %chan oi
    if stimear ==1
    chans =[find(strcmp(data.label,'Cz'))];%  find(strcmp(data.label,'EXG2'))]; % right tiptrode
    elseif stimear ==2
    chans =[find(strcmp(data.label,'Cz'))];%  find(strcmp(data.label,'EXG1'))];
    end
